...
| 标记 | 角色 | 职责文件 |
|------|------|---------|
| `@pm` | PM 项目经理 | `.Codex/agents/pm.md` |
| `@fe` | FE 前端工程师 | `.Codex/agents/fe.md` |
| `@be` | BE 后端工程师 | `.Codex/agents/be.md` |
| `@rpa` | RPA 自动化工程师 | `.Codex/agents/rpa.md` |
| `@biz` | 业务专家 | `.Codex/agents/biz.md` |
| `@ai` | AI 人工智能工程师 | `.Codex/agents/ai.md` |
| `@qa` | QA 测试工程师 | `.Codex/agents/qa.md` |
